            ...
            if(document.getElementsByTagName('textarea')[0] !== undefined){
                ...
                for (i = 0; i < get_data_array.length; i++) { 
                    ...
                    if((sent_array[i]!==undefined) && (i!=0) ) {
                        if((sent_array[i][0]!==undefined) && (sent_array[i][1]!==undefined) && (sent_array[i][2]!==undefined) ){
                            console.log(i + ' = YYY');
                            if(i==1){
...
<button class="noprint" onclick="javascript:print()">列印</button>
<center>
